...
public class QuotesFragment extends BaseFragment implements View.OnClickListener, CommonActionListener {
    private ActivityGridBinding binding;
    private ArrayList<DashboardChildModel> quotesArraylist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BaseAdapter dashboardChildAdapter = new BaseAdapter(getActivity(), quotesArraylist, R.layout.dashboard_child_item, this);
    ...
    private void startWork() {
        ...
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_bill_gates), R.drawable.biily, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_jeff_bezos), R.drawable.jaff, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_naredra_modi), R.drawable.img_modi, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_Stephen_Hawking), R.drawable.imgstephen, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_ratan_tata), R.drawable.img_tata, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_br_ambedkar), R.drawable.img_saheb, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_swami_vivekananda), R.drawable.img_vivekanada, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_obama), R.drawable.img_obama, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_albert_einstein), R.drawable.img_albert, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_abdul_kalam), R.drawable.img_kalam, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_Sundar_Pichai), R.drawable.img_sundar, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_jack_ma), R.drawable.imgjackma, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_chanakya), R.drawable.img_chankya, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_satya_nadela), R.drawable.nadela, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_steve_jobs), R.drawable.img_steve, false));
        quotesArraylist.add(new DashboardChildModel(getResources().getString(R.string.cel_elon_musk), R.drawable.img_elon, false));
        quotesArraylist.add(new DashboardChildModel("Motivational", R.drawable.bg_m, false));
        quotesArraylist.add(new DashboardChildModel("Inspirational", R.drawable.bg_i, false));
        quotesArraylist.add(new DashboardChildModel("Happiness", R.drawable.bg_h, false));
        quotesArraylist.add(new DashboardChildModel("Relationship", R.drawable.bg_r, false));
        quotesArraylist.add(new DashboardChildModel("Success", R.drawable.bg_s, false));
        quotesArraylist.add(new DashboardChildModel("Love", R.drawable.bg_l, false));
        quotesArraylist.add(new DashboardChildModel("Alone", R.drawable.bg_a, false));
        quotesArraylist.add(new DashboardChildModel("Birthday", R.drawable.bg_c, false));
        quotesArraylist.add(new DashboardChildModel("Business", R.drawable.bg_bb, false));
        quotesArraylist.add(new DashboardChildModel("Dreams", R.drawable.bg_d, false));
        quotesArraylist.add(new DashboardChildModel("Failure", R.drawable.bg_f, false));
        quotesArraylist.add(new DashboardChildModel("Fitness", R.drawable.bg_ff, false));
        quotesArraylist.add(new DashboardChildModel("Forgiveness", R.drawable.bg_fff, false));
        quotesArraylist.add(new DashboardChildModel("Mom", R.drawable.bg_m, false));
        quotesArraylist.add(new DashboardChildModel("Friendship", R.drawable.bg_ffff, false));
        quotesArraylist.add(new DashboardChildModel("Imagination", R.drawable.bg_ii, false));
        quotesArraylist.add(new DashboardChildModel("Life", R.drawable.bg_ll, false));
        quotesArraylist.add(new DashboardChildModel("Sad", R.drawable.bg_s, false));
        quotesArraylist.add(new DashboardChildModel("Knowledge", R.drawable.bg_k, false));
        quotesArraylist.add(new DashboardChildModel("Marriage", R.drawable.bg_mmm, false));
        quotesArraylist.add(new DashboardChildModel("Romantic", R.drawable.bg_r, false));
        quotesArraylist.add(new DashboardChildModel("Coming Soon", R.drawable.coming_soon, false));
    }
